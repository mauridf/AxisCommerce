...
namespace AxisCommerce.Infrastructure.Migrations
{
    ...
    [Migration("20241118195334_ConfigTableVendedor")]
    partial class ConfigTableVendedor
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AxisCommerce.Domain.Entities.Loja.Vendedor", b =>
                {
                    ...
                    b.ToTable("Vendedores", null, t =>
                        {
                            t.HasCheckConstraint("CK_Vendedor_Gerente", "\"IndicaGerente\" IN (false, true)");

                            t.HasCheckConstraint("CK_Vendedor_OperadorCaixa", "\"IndicaOperadorCaixa\" IN (false, true)");
                        });
                });
